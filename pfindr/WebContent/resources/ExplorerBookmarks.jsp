...
<body>
	...
	<div>
		...
		<a id="queryTool" class="link-style banner-text" href="/pfindr/explore">Phenotype Explorer</a> &nbsp;&nbsp;
	</div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display"
					...
					<% ArrayList<HashMap<String,String>> bookmarks = (ArrayList<HashMap<String,String>>) request.getAttribute("bookmarks");
						...
						<tr>
							...
							%>
							<td align="center"><a href="/pfindr/explore?action=getBookmark&amp;qid=<%=encodedName%>"><%=name%></a></td>
